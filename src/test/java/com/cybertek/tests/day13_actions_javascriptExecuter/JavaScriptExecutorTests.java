package com.cybertek.tests.day13_actions_javascriptExecuter;
...
public class JavaScriptExecutorTests {
    ...
    public void jsExecutorTest1(){
        ...
        //since it's an interface, we cannot create an object and we cant use new keyword
        ...
        js.executeScript("alert('HELLO SPARTANS!!!!')"); // alert text/message
        SeleniumUtils.waitPlease(3);
        //Alert interface handles alerts
        //what is alert?
        //It looks like pop up window
        Alert alert = driver.switchTo().alert();
        //we can use accept() method to select OK in the pop up (accepting the alert message)
        alert.accept();
        SeleniumUtils.waitPlease(3);
    ...
    @Test
    public void scrollTest1(){ // we r scrolling the page, to read the page/paragraph from the book.. ect
    ...
    public void scrollTest2(){
        ...
        //once you see footerLink, script will stop scrolling
        js.executeScript("arguments[0].scrollIntoView(true)", footerLink);
        SeleniumUtils.waitPlease(2);
        //to click with jsexecutor
        // scroll intoView until the first element becomes visible
