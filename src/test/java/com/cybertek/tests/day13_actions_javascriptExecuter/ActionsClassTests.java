...
public class ActionsClassTests {
    ...
    String enabledOptionLocator = "ui-id-3"; // this is 'id' locator
    String downloadsOptionLocator = "ui-id-4"; // id locator
    String pdfoptionLocator = "ui-id-5"; // id locator
    //drag and drop
    String MoonLocator = "draggable"; // id
    String EarthLocator = "droptarget"; // id
    ...
    public void hoverTest1(){
        ...
        //we have provided object of webdriver
        Actions action = new Actions(driver);
        //moveToElement method is used to hover on element
