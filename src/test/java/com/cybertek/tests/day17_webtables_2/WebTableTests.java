package com.cybertek.tests.day17_webtables_2;
...
public class WebTableTests extends TestBase {
    ...
    /**
     * Write a method that will return count of rows
     * In this case, object of by allows us to specify table locator of any type (id, class, xpath etc)
     */
    public int getCountOfRows(By by){ // overloaded method which takes parameter
